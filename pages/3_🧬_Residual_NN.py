...
# =========================
st.set_page_config(
    page_title="Residual NN – Simulasi Prediksi Genre",
    layout="wide"
)
...
def load_assets():
    ...
    model = tf.keras.models.load_model("models/model_residual_nn.h5")
...
# TITLE
# =========================
st.title("🧬 Residual Neural Network – Simulasi Prediksi Genre")
